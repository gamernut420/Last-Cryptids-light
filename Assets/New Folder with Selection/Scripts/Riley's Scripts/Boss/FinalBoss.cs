...
public class FinalBoss : MonoBehaviour, IDamage
{
    ...
    // ADDED FOR BOSS HEALTH BAR:
    // Tells the HUD when the boss fight begins.
    ...
    [Header("Objective")]
    [SerializeField]
    private ObjectiveData bossObjective;
    ...
    [SerializeField]
    private float phase2HP = 500f;

    [SerializeField]
    private float phase3HP = 200f;

    [SerializeField]
    private float phase2TransitionDelay = 5f;
    ...
    [SerializeField]
    private float phase1Speed = 3.5f;

    [SerializeField]
    private float phase2Speed = 5f;

    [SerializeField]
    private float phase3Speed = 7f;
    ...
    [SerializeField]
    private float meleeHitboxDuration = 0.5f;
    ...
    [SerializeField]
    private float rangedAttackCooldown = 15f;

    [SerializeField]
    private float rangedAttackChargeTime = 1f;

    [SerializeField]
    private float rangedAttackDuration = 2f;
    ...
    [SerializeField]
    private float projectileHeight = 2f;

    [SerializeField]
    private float hitboxExtendSpeed = 20f;
    ...
    [SerializeField]
    private int maxEnemiesAlive = 6;

    [SerializeField]
    private int enemiesPerSummon = 2;
    ...
    [SerializeField]
    private float teleportDistance = 30f;

    [SerializeField]
    private float teleportNearPlayerDistance = 8f;
    ...
    [SerializeField]
    private Transform[] energyFieldSpawnPoints;

    [SerializeField]
    int energyFieldsPerAttack = 2;

    [SerializeField]
    float energyFieldCooldown = 10f;

    [SerializeField]
    float energyFieldDuration = 6f;
    ...
    void Start()
    {
        ...
        // ADDED FOR BOSS HEALTH BAR:
        // Show the boss health bar and initialize it
        // at full health when the boss starts.
        ...
        int amount)
    {
        ...
        // ADDED FOR BOSS HEALTH BAR:
        // Update the boss HUD immediately after
    ...
    private void Die()
    {
        ...
        // ADDED FOR BOSS HEALTH BAR:
        // Hide the boss health bar when the
        // encounter has ended.
        BossDefeated?.Invoke();
